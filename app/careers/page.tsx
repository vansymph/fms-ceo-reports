...
const roles = [
  {
    ...
    description: "We're looking for a talented developer who thinks like a builder. You don't need a long list of production apps — you need sharp instincts, the ability to learn fast, and the drive to ship things that matter. You'll work closely with our CTO and have real ownership over what you build.",
